...
items = list(range(1, param_item_count + 1))  # 从 1 开始，避免 n=0 的退化
print(f'Generated items (count={len(items)}), sample={items[:10]}')
...
print(f'Item batches: {len(batches)} batches, sizes={[len(b) for b in batches]}')
